...
docker cp ./repos/authenticate erdiko_users_php:/authorize
docker cp ./repos/authenticate/users erdiko_users_php:/users

docker cp ./ erdiko_users_web:/code
docker cp ./repos/authenticate erdiko_users_web:/authenticate
docker cp ./repos/authenticate erdiko_users_web:/authorize
docker cp ./repos/authenticate/users erdiko_users_web:/users
